...
export default function ResourcesPage() {
  ...
  return (
    <PageShell>
      ...
      <Reveal>
        <div className="p-6 text-center" style={{ border: "1px dashed rgba(216,175,114,0.2)", borderRadius: "1rem" }}>
          <p className="text-sm mb-2" style={{ color: "var(--muted-2)", fontFamily: "'DM Sans', sans-serif" }}>Want to suggest a resource?</p>
          <a href={SOCIAL.instagram} target="_blank" rel="noopener noreferrer" className="text-xs" style={{ color: "#d8af72", fontFamily: "'DM Sans', sans-serif" }}>
