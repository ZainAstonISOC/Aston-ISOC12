    ...
    <div style={{ background: "#0D1025", minHeight: "100vh", paddingTop: "5rem" }}>
      <div className="container py-16">
        ...
        <div className="mb-16">
          ...
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(2.2rem,5vw,3.8rem)", fontWeight: 300, color: "#fff", lineHeight: 1.1 }}>
            Prayer Times
          </h1>
          <span className="gold-rule" />
          <p style={{ color: "#9CA3AF", fontFamily: "'DM Sans', sans-serif", fontSize: "0.9rem" }}>
            Birmingham, UK · {today}
          </p>
          <p className="mt-1 text-xs" style={{ color: "#34D399", fontFamily: "'DM Sans', sans-serif" }}>
            ...
            {times.map((p, i) => (
              ...
              >
                <p
                  ...
                  style={{ color: i === 2 ? "#C9A227" : "#4B5563", fontFamily: "'DM Sans', sans-serif" }}
                >
                  {p.name}
                </p>
                <p
                ...
                {p.iqamaTime && p.name !== "Sunrise" && (
                  <p className="mt-2 text-xs" style={{ color: "#4B5563", fontFamily: "'DM Sans', sans-serif" }}>
                    Iqama: {p.iqamaTime}
                  </p>
                )}
                {i === 2 && (
                  <p className="mt-1.5 text-xs font-semibold tracking-widest uppercase" style={{ color: "#C9A227", fontFamily: "'DM Sans', sans-serif" }}>
                    Next
                  </p>
                )}
              </div>
        ...
        <Reveal delay={100}>
          ...
          >
            <div>
              <p className="text-sm font-medium" style={{ color: "#E5E7EB", fontFamily: "'DM Sans', sans-serif" }}>Live Prayer Times Display</p>
              <p className="text-xs mt-0.5" style={{ color: "#6B7280", fontFamily: "'DM Sans', sans-serif" }}>Digital display for the on-campus prayer room at Aston</p>
            </div>
          ...
          <Reveal>
            <div className="h-full" style={{ background: "#131629", border: "1px solid rgba(201,162,39,0.1)", borderRadius: "1rem", overflow: "hidden" }}>
              <div className="px-6 py-4" style={{ borderBottom: "1px solid rgba(201,162,39,0.08)" }}>
                ...
                <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.4rem", fontWeight: 300, color: "#fff" }}>Prayer Rooms</h2>
              </div>
              <div className="divide-y" style={{ borderColor: "rgba(201,162,39,0.06)" }}>
                {[
                  ...
                  <div key={r.room} className="px-6 py-3.5" style={{ borderColor: "rgba(201,162,39,0.06)" }}>
                    <p className="text-sm font-medium" style={{ color: "#E5E7EB", fontFamily: "'DM Sans', sans-serif" }}>{r.room}</p>
                    <p className="text-xs mt-0.5" style={{ color: "#4B5563", fontFamily: "'DM Sans', sans-serif" }}>{r.notes} · Wudu: {r.wudu}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <Reveal delay={100}>
            <div className="h-full flex flex-col gap-4">
              ...
              >
                ...
                <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.6rem", fontWeight: 300, color: "#fff", marginBottom: "1rem" }}>
                  Jumu&apos;ah Prayer
                </h2>
                <div className="space-y-1.5 text-sm" style={{ color: "#9CA3AF", fontFamily: "'DM Sans', sans-serif" }}>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={m.name} className="flex justify-between items-center">
                      <span className="text-sm" style={{ color: "#9CA3AF", fontFamily: "'DM Sans', sans-serif" }}>{m.name}</span>
                      <span className="text-xs" style={{ color: "#4B5563", fontFamily: "'DM Sans', sans-serif" }}>{m.dist}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="p-6" style={{ background: "#131629", border: "1px solid rgba(201,162,39,0.1)", borderRadius: "1rem" }}>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={e} className="flex items-start gap-2.5 text-sm" style={{ color: "#9CA3AF", fontFamily: "'DM Sans', sans-serif" }}>
