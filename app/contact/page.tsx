...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Aston ISOC, join the society, volunteer, or follow us on social media.",
};
          ...
          {[
            {
              ...
              title: "Instagram",
              sub: "@astonisoc",
              desc: "Our primary channel. DM us for quick questions, announcements, and all things ISOC.",
            ...
            },
            {
              ...
              desc: "Join the brothers or sisters WhatsApp group for daily updates, prayer times, and community chat.",
            ...
            },
            {
              icon: "🔗",
              title: "Linktree",
              sub: "All official links",
              desc: "Every official ISOC link in one place, from membership to donation campaigns.",
              href: SOCIAL.linktree,
              cta: "View all links",
            },
          ].map((ch, i) => (
            <Reveal key={ch.title} delay={i * 80}>
              <a href={ch.href} target="_blank" rel="noopener noreferrer" className="card link" style={{ textDecoration: "none", display: "block" }}>
                ...
                <span style={{ fontFamily: DM, fontSize: "0.78rem", fontWeight: 600, color: "var(--gold)", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                  {ch.cta} →
                </span>
              </a>
            </Reveal>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "2rem" }}>
            <div>
              ...
              <p style={{ fontFamily: DM, color: "var(--muted)", maxWidth: "48ch", lineHeight: 1.75 }}>
                £5 for the full academic year. Access all events, both WhatsApp communities, the student discount card, and a lifelong network of Muslim students and alumni at Aston.
              </p>
            </div>
      ...
      <Reveal delay={80}>
        <div style={{ marginTop: "4rem", marginBottom: "2rem" }}>
          ...
          <p style={{ fontFamily: DM, color: "var(--muted)", maxWidth: "56ch", lineHeight: 1.75, marginBottom: "2.5rem" }}>
            Aston ISOC runs on its volunteers. Every campaign, every event, every initiative is powered by students who give their time for the sake of their community. Here is where you can help.
          </p>
        </div>
      </Reveal>
        ...
        {campaigns.map((c, i) => (
          <Reveal key={c.id} delay={i * 80}>
            <div className="card" style={{ borderColor: "rgba(216,175,114,0.15)" }}>
              ...
              <p style={{ fontFamily: DM, fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--gold)", marginBottom: "0.7rem" }}>
                {c.tagline}
              </p>
              <p style={{ fontFamily: DM, fontSize: "0.88rem", color: "var(--muted)", lineHeight: 1.7, marginBottom: "1.2rem" }}>
                {c.description.slice(0, 120)}...
              </p>
              <div style={{ marginBottom: "0.85rem" }}>
                <p style={{ fontFamily: DM, fontSize: "0.72rem", color: "var(--muted-2)", marginBottom: "0.4rem" }}>Roles available:</p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "0.35rem" }}>
                  {c.roles.slice(0, 3).map(r => (
                    <span key={r} className="badge badge-muted" style={{ fontSize: "0.55rem" }}>{r}</span>
                  ))}
                  {c.roles.length > 3 && <span className="badge badge-muted" style={{ fontSize: "0.55rem" }}>+{c.roles.length - 3} more</span>}
                </div>
              </div>
