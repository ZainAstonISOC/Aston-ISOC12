    ...
    <div>
      ...
      <section className="section section--tight">
        <div className="container">
          ...
          <div className="grid cols-3 link-grid">
            {[
              {
                label: "Instagram", sub: "@astonisoc — primary channel", href: SOCIAL.instagram,
              ...
              {
                label: "WhatsApp", sub: "Community announcements", href: WHATSAPP.community,
              ...
              {
                label: "Linktree", sub: "All official links", href: SOCIAL.linktree,
                icon: <path d="M13.511 5.853l4.005-4.117 2.2 2.136-4.192 4.007h5.989v3.104h-6.016l4.226 4.008-2.2 2.165-5.528-5.38-5.498 5.38-2.199-2.165 4.226-4.008H2.487V7.879h5.988L4.283 3.872l2.2-2.136 4.005 4.117V0h3.023v5.853zm-3.023 9.285h3.023V24h-3.023v-8.862z" />,
              },
            ].map((s, i) => (
              <Reveal key={s.label} delay={i * 80}>
                <a href={s.href} target="_blank" rel="noopener noreferrer" className="card link"
                  style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "2.4rem 1.5rem" }}>
                  <span className="icon-badge" style={{ marginBottom: "1.3rem" }}>
                    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">{s.icon}</svg>
                  </span>
                  <h3 style={{ fontFamily: PF, fontSize: "1.2rem", color: "#fff", marginBottom: "0.4rem" }}>{s.label}</h3>
                  <p style={{ fontFamily: DM, fontSize: "0.88rem", color: "#8d86a3" }}>{s.sub}</p>
                  <span style={{ marginTop: "auto", paddingTop: "1.4rem", fontFamily: DM, fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#d8af72", display: "inline-flex", alignItems: "center", gap: "0.45rem" }}>
                    Open
