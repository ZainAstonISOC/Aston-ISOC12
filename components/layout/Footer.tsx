...
export default function Footer() {
  return (
    <footer style={{ borderTop: "1px solid rgba(216,175,114,0.12)", marginTop: "2rem", padding: "clamp(3rem,6vw,4.5rem) 0 2rem", position: "relative" }}>
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1.2fr", gap: "2.5rem", marginBottom: "3rem" }}
            ...
            <div style={{ display: "flex", gap: "0.6rem", marginTop: "1.3rem" }}>
              {[
                ...
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label}
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.color="#d8af72"; (e.currentTarget as HTMLAnchorElement).style.borderColor="rgba(216,175,114,0.5)"; (e.currentTarget as HTMLAnchorElement).style.transform="translateY(-2px)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.color="#8d86a3"; (e.currentTarget as HTMLAnchorElement).style.borderColor="rgba(216,175,114,0.15)"; (e.currentTarget as HTMLAnchorElement).style.transform="translateY(0)"; }}>
                  {s.svg}
                </a>
              ))}
            </div>
