...
export const committeeMembers: CommitteeMember[] = [
  ...
  { id: "vice-brother",     name: "Shaz",            role: "Vice Brother",       year: "2026/27", bio: "Supports the Head Brother in brothers events and day-to-day operations.", section: "executive" },
  ...
  { id: "marketing-sisters-1", name: "Hibah",        role: "Marketing Sisters Officer",   year: "2026/27", bio: "Creates sisters-focused marketing assets and promotional designs.", section: "marketing" },
  ...
  // SOCIALS (formerly Social Media)
  { id: "socials-head",       name: "Ahmad Gebriel", role: "Head of Socials",             year: "2026/27", bio: "Manages ISOC social events, community engagement, and content creation across all platforms to keep the community connected and informed.", section: "social_media" },
  { id: "socials-brothers-1", name: "Fayez",         role: "Socials Brothers Officer",    year: "2026/27", bio: "Creates brothers-focused social content, organises community events, and drives engagement within the brothers community.", section: "social_media" },
  { id: "socials-brothers-2", name: "Juwainy",       role: "Socials Brothers Officer",    year: "2026/27", bio: "Produces video content, supports social events, and manages brothers community campaigns.", section: "social_media" },
  { id: "socials-sisters",    name: "Shafiya",       role: "Socials Sisters Officer",     year: "2026/27", bio: "Manages sisters social presence, creates community content, and organises sisters engagement activities.", section: "social_media" },
  ...
  { id: "advocacy-brothers-2", name: "Ahmed K",      role: "Advocacy Brothers Officer",   year: "2026/27", bio: "Coordinates advocacy initiatives and community outreach programmes.", section: "advocacy" },
